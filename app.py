...
# Contato do pastor é procurado na aba Fé. Não é gravado no código.
# ==============================================================================
...
with h2:
# Um único sino. Vermelho somente quando há evento no dia.
...
# ==============================================================================
# MATRÍCULA — SEM CAMPO "CADASTRADOS"
# ==============================================================================
...
if nomes_t:
# Cada aluno aparece com sua foto e botão próprio.
...
# Também cria um cadastro local mínimo, marcado como pendente.
st.session_state.dados_app["alunos"][chave] = {
"nome": nc_nome, "data_inicio": nc_inicio.strftime("%d/%m/%Y"),
"biometria_cadastrada": False, "assinatura_cadastrada": False,
...
pedidos_batismo = st.session_state.dados_app.get("batizados", [])

# Se houver registros reais de interesse, usa-os; caso contrário mantém os
# contadores administrativos já existentes.
